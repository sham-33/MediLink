      ...
      <div>
        {doctors.slice(0, 3).map((item, index) => (
          <div className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b" key={index}>
            <div>
              <img className="w-32 bg-[var(--bg-brown)]" src={item.image} alt="" />
            </div>
            ...
            <div className="flex flex-col gap-2 justify-end">
              <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-[var(--bg-primary)] hover:text-white transition-all duration-300">Pay Online</button>
